# Invokes the ported engine via apps/api/scripts/backtest.py (subprocess: cleaner than sys.path bootstrap - CLI owns its own import setup).
import json
import subprocess
import sys
